...
HD_PWD='/home/mayma/Downloads/simple_rs-master/zybo_vivado_2017.1/rs_test/prototype/prototype.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rs_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rs_tb.tcl
